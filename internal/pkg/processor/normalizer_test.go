...
func TestNormalizeProcess(t *testing.T) {
	...
	assert.Equal(t, &normRequestData{Orig: []*normText{{Text: " a a"}}}, cp1)
...
// 		{name: "replace several longer", args: args{output: normResponseData{Rep: []*normResponseDataRep{{Beg: 10, End: 21, Text: "aa1010aa"}, {Beg: 35, End: 39, Text: "bbbbbb"}}},
// 			input: []string{"vienas du olia oooo", "oooo", "vienas du olia oooo"}},
