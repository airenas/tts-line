...
func (m *Synthesizer) Work(ctx context.Context, in *tapi.TTSRequestConfig) (*tapi.Result, error) {
	args := m.Called(in)
...
func (m *HTTPInvokerJSON) InvokeText(ctx context.Context, in string, out interface{}) error {
	args := m.Called(in, out)
	return args.Error(0)
}

func (m *HTTPInvokerJSON) InvokeJSON(ctx context.Context, in interface{}, out interface{}) error {
	args := m.Called(in, out)
	return args.Error(0)
}

func (m *HTTPInvokerJSON) InvokeJSONU(ctx context.Context, URL string, in interface{}, out interface{}) error {
